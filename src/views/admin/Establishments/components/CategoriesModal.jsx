...
import { addEstablishmentCategory } from "services/establishmentApis";
import Notify from "simple-notify";

const CategoriesModal = ({ fetchEstablishments }) => {
  ...
  const addEstablishment = async () => {
    try {
      await addEstablishmentCategory(obj);
    } catch (e) {
      console.log(e);
    }
  };
        ...
        {inputFields?.map((item) => (
          <>
            <InputField
              ...
              placeholder="eg: Blood center, Hospital etc"
              id="profession"
              type="text"
